package eu.siacs.conversations.dns;

import java.io.DataInputStream;
import java.io.IOException;
import java.util.HashMap;

import eu.siacs.conversations.dns.record.A;
import eu.siacs.conversations.dns.record.AAAA;
import eu.siacs.conversations.dns.record.CNAME;
import eu.siacs.conversations.dns.record.Data;
import eu.siacs.conversations.dns.record.NS;
import eu.siacs.conversations.dns.record.SRV;
