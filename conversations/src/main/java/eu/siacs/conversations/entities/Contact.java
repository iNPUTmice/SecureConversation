...
public class Contact implements ListItem, Blockable {
	...
	public boolean showInRoster() {
		return (this.getOption(Options.IN_ROSTER) && (!this
					.getOption(Options.DIRTY_DELETE)))
			|| (this.getOption(Options.DIRTY_PUSH));
	}
	...
	public void parseSubscriptionFromElement(Element item) {
		...
		if (!this.getOption(Options.DIRTY_PUSH)) {
			if ((ask != null) && (ask.equals("subscribe"))) {
				this.setOption(Options.ASKING);
			} else {
				this.resetOption(Options.ASKING);
			}
		}
	}
